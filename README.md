...
[![GoDoc](https://godoc.org/github.com/philchia/agollo?status.svg)](https://pkg.go.dev/github.com/gitcloneese/agollo)
...
**v4:**[![goproxy.cn](https://goproxy.cn/stats/github.com/gitcloneese/agollo/badges/download-count.svg)](https://goproxy.cn)
...
```sh
go get -u github.com/gitcloneese/agollo
```
...
```golang
import "github.com/gitcloneese/agollo"
```
